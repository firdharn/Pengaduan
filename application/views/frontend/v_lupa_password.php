...
<body>
<?php
    if($this->session->flashdata('pesan_lupa_password_pengaduan')){
        $message = $this->session->flashdata('pesan_lupa_password_pengaduan');
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="<?php echo base_url('act/lupa_password'); ?>" method="post">
                            ...
                            <div class="form-group">
                                <button type="submit" name="submit" class="btn btn-info btn-md">Reset Password</button>
                            </div>
                            <br>
                            <div id="register-link" class="text-right">
                                <span>Kembali ke login ?</span>&nbsp;<a href="<?= base_url('act/login') ?>" class="text-info">Login disini</a>
                            </div>                            
                        </form>
                    </div>
                </div>
