...
<body>
<?php
    if($this->session->flashdata('pesan_register_pengaduan')){
        $message = $this->session->flashdata('pesan_register_pengaduan');
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <?php
                            echo form_open('act/register_process', 'id="login-form" class="form"');
                        ?>
                            ...
                            <div class="form-group">
                                <label for="password" class="text-info">Telepon:</label><br>
                            ...
                            <div id="register-link" class="text-right">
                                <span>Sudah punya akun ?</span>&nbsp;<a href="<?= base_url('act/login') ?>" class="text-info">Login disini</a>
                            </div>    
                        <?php echo form_close();?>
                    </div>
                </div>
